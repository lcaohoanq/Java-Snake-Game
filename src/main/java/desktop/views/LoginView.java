...
import desktop.constants.ResourcePaths;
import desktop.styles.UISizes;
import desktop.styles.UILabels;
import desktop.controllers.LoginController;
import desktop.controllers.PlayController;
import desktop.models.data.Account;
import desktop.models.data.LoginData;
import desktop.models.ui.LoginModel;
...
public class LoginView extends MyFrame implements ToggleHandler, HoverHandler, LoginData {
    ...
    public void handleSuccess() {
        ...
        cardLayout.next(jPanel_Right_Bottom_Button);
