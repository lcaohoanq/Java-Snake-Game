...
public class RegisterFormView extends JFrame {
  ...
  private void setUpTopZone() {
    jLabel_Logo.setFont(FontHandler.LOGO);
    ...
    jPanel_TopZone.setBorder(BorderHandler.LOGO);
    jPanel_TopZone.add(jLabel_Logo, BorderLayout.CENTER);
  }

  private void setUpUsername() {
    jLabel_Username.setFont(FontHandler.JLABEL);
    jLabel_Username.setBorder(BorderHandler.JLABEL);
  ...
  private void setUpPassword() {
    jLabel_Password.setFont(FontHandler.JLABEL);
    jLabel_Password.setBorder(BorderHandler.JLABEL);
    ...
    jPasswordField_Password.setFont(FontHandler.INPUT);
    ...
    jPanel_Password.setBorder(BorderHandler.PASSWORD_PANEL);
  ...
  private void setUpConfirmPassword() {
    jLabel_ConfirmPassword.setFont(FontHandler.JLABEL);
    jLabel_ConfirmPassword.setBorder(BorderHandler.JLABEL);
    ...
    jPasswordField_ConfirmPassword.setFont(FontHandler.INPUT);
    ...
    jPanel_ConfirmPassword.setBorder(BorderHandler.PASSWORD_PANEL);
  ...
  private void setUpBottomZone() {
    ...
    jButton_RegisterButton.setFont(FontHandler.JBUTTON);
    ...
    jLabel_OtherOptions_Label.setFont(FontHandler.OTHERS);
    ...
    jButton_OtherOptions_Button.setFont(FontHandler.OTHERS);
    ...
    jPanel_Button.setBorder(BorderHandler.JBUTTON);
    ...
    jPanel_OtherOptions.setBorder(BorderHandler.OTHERS);
